    ...
    <div className="px-4 pt-4 sm:px-8 md:px-16 lg:pt-15 lg:px-28 flex flex-col lg:flex-row gap-8 sm:gap-12 lg:gap-16 justify-center items-center">
      <div className="flex gap-6 sm:gap-8 md:gap-10 flex-col w-full lg:w-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 md:gap-8">
          <button className="bg-[#FFCD2E] h-10 sm:h-12 md:h-14 px-6 sm:px-8 md:px-10 text-white text-sm sm:text-base md:text-lg rounded-sm hover:bg-[#E5B726] transition-colors w-full sm:w-auto">
            Start solving
          </button>
          <button className="flex items-center gap-2 justify-center sm:justify-start w-full sm:w-auto">
            ...
            <p className="text-[#FFCD2E] text-sm sm:text-base md:text-lg">know more</p>
          </button>
        </div>
      </div>
      <img className="h-auto w-full md:w-180 lg:w-200 xl:w-155" src="/homeIcon.svg"/>
    </div>
  );
}
