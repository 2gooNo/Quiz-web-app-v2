  ...
  return (
    <div className="flex min-h-screen w-full flex-col lg:flex-row">
      ...
      <div className="flex-1 flex flex-col p-6 sm:p-8 md:p-12 lg:p-16 xl:p-20 items-center justify-center gap-6 sm:gap-8 md:gap-10 max-w-none lg:max-w-[50%]">
        <img
          className="h-auto w-32 sm:w-40 md:w-48 lg:w-56 xl:w-80"
          src="/logo.svg"
          alt="Logo"
        />
        ...
        <button
          ...
          className="w-full max-w-xs sm:max-w-sm h-12 sm:h-14 bg-[#FFCD2E] text-white text-base sm:text-lg font-semibold rounded hover:bg-[#E5B726] transition-colors"
        >
          Sign up
        </button>
      </div>
